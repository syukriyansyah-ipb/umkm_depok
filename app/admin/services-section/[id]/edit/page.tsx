...
import { marked } from 'marked'; // Impor marked untuk konversi Markdown ke HTML
...
export default function EditProduct({ params }: { params: Promise<{ id: string }> }) {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      // Konversi description dari Markdown ke HTML
      const descriptionHtml = marked(values.description);

      // Simpan data dengan description dalam format HTML
      const response = await fetch(`/api/products/${resolvedParams.id}`, {
        ...
        body: JSON.stringify({
          ...values,
          descriptionHtml, // Tambahkan field descriptionHtml
        }),
      });
